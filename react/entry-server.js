...
const viteSSR = function (App, { routes, base, prepassVisitor, PropsProvider, pageProps, transformState = serializeState, }, hook) {
    return async function (url, { manifest, preload = false, ...extra } = {}) {
        ...
        const helmetContext = {};
        const styledContext = {};
        const app = appWrapper(React.createElement(HelmetProvider, { context: helmetContext }, React.createElement(StaticRouter, {
            basename: routeBase,
            location: fullPath,
        }, React.createElement(App, context))), styledContext);
